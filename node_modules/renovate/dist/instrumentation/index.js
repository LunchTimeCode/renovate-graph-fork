...
function init() {
    ...
    const traceProvider = new sdk_trace_node_1.NodeTracerProvider({
        resource: new resources_1.Resource({
            ...
            [semantic_conventions_1.SemanticResourceAttributes.SERVICE_NAME]: process.env.OTEL_SERVICE_NAME ?? 'renovate',
            [semantic_conventions_1.SemanticResourceAttributes.SERVICE_NAMESPACE]: process.env.OTEL_SERVICE_NAMESPACE ?? 'renovatebot.com',
            [semantic_conventions_1.SemanticResourceAttributes.SERVICE_VERSION]: process.env.OTEL_SERVICE_VERSION ?? expose_cjs_1.pkg.version,
        }),
    });
    // add processors
