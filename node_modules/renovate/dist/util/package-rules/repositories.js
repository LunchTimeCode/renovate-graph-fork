...
class RepositoriesMatcher extends base_1.Matcher {
    ...
    excludes({ repository }, { excludeRepositories }) {
        if (is_1.default.undefined(excludeRepositories)) {
            return null;
        }
        if (is_1.default.undefined(repository)) {
            return false;
        }
        return (0, string_match_1.matchRegexOrGlobList)(repository, excludeRepositories);
    }
}
