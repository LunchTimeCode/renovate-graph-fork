...
class FileNamesMatcher extends base_1.Matcher {
    matches({ packageFile, lockFiles }, { matchFileNames }) {
        ...
        return matchFileNames.some((matchFileName) => (0, minimatch_1.minimatch)(matchFileName, { dot: true }).match(packageFile) ||
            (is_1.default.array(lockFiles) &&
                lockFiles.some((lockFile) => (0, minimatch_1.minimatch)(matchFileName, { dot: true }).match(lockFile))));
    }
}
