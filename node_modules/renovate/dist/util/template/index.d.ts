...
export declare function proxyCompileInput(input: CompileInput): CompileInput;
...
export declare function containsTemplates(value: unknown, templates: string | string[]): boolean;
export {};
