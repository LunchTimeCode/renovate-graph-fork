...
export declare const Jsonc: z.ZodEffects<z.ZodString, string | number | boolean | import("type-fest").JsonObject | JsonValue[] | readonly JsonValue[] | null, string>;
export declare const UtcDate: z.ZodEffects<z.ZodString, DateTime<boolean>, string>;
export declare const Yaml: z.ZodEffects<z.ZodString, string | number | boolean | import("type-fest").JsonObject | JsonValue[] | readonly JsonValue[] | null, string>;
export declare const MultidocYaml: z.ZodEffects<z.ZodString, JsonValue[] | readonly JsonValue[], string>;
export declare const Toml: z.ZodEffects<z.ZodString, unknown, string>;
export {};
