...
exports.deleteNonDefaultConfig = exports.getConfig = exports.getParsedContent = void 0;
...
async function getParsedContent(file) {
    ...
    switch (upath_1.default.extname(file)) {
        ...
        case '.cjs':
        case '.js': {
            const tmpConfig = await Promise.resolve(`${upath_1.default.isAbsolute(file) ? file : `${process.cwd()}/${file}`}`).then(s => tslib_1.__importStar(require(s)));
...
async function deleteNonDefaultConfig(env) {
