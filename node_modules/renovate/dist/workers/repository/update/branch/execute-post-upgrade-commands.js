...
async function postUpgradeCommandsExecutor(filteredUpgradeCommands, config) {
    ...
    const allowedPostUpgradeCommands = global_1.GlobalConfig.get('allowedPostUpgradeCommands');
    const allowPostUpgradeCommandTemplating = global_1.GlobalConfig.get('allowPostUpgradeCommandTemplating');
