...
async function processBranch(branchConfig) {
    ...
    try {
        ...
        if (!branchExists &&
            (0, limits_1.isLimitReached)('Branches') &&
            !dependencyDashboardCheck &&
        ...
        if (branchExists) {
            ...
            const branchIsModified = await scm_1.scm.isBranchModified(config.branchName);
            if (branchPr) {
        ...
        if (branchPr) {
            const platformOptions = (0, pr_1.getPlatformPrOptions)(config);
