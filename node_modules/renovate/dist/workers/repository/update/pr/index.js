...
exports.ensurePr = exports.updatePrDebugData = exports.getPlatformPrOptions = void 0;
...
async function ensurePr(prConfig) {
    ...
    try {
        ...
        if (global_1.GlobalConfig.get('dryRun')) {
            ...
            try {
                if (!dependencyDashboardCheck &&
                    (0, limits_1.isLimitReached)('PullRequests') &&
                ...
                (0, limits_1.incLimitedValue)('PullRequests');
