...
exports.shouldSkipChangelogMd = exports.addReleaseNotes = exports.releaseNotesCacheMinutes = exports.getReleaseNotesMd = exports.getReleaseNotesMdFile = exports.getReleaseNotesMdFileInner = exports.getReleaseNotes = exports.massageName = exports.massageBody = exports.getCachedReleaseList = exports.getReleaseList = void 0;
...
async function getReleaseNotes(project, release, config) {
    ...
    // TODO: types (#22198)
    logger_1.logger.trace(`getReleaseNotes(${repository}, ${version}, ${packageName})`);
...
function getExactReleaseMatch(packageName, version, releases) {
    const exactReleaseReg = (0, regex_1.regEx)(`${packageName}[@_-]v?${version}`);
