...
async function filterInternalChecks(config, versioning, bucket, sortedReleases) {
    ...
    if (internalChecksFilter === 'none') {
        ...
        for (const candidateRelease of sortedReleases.reverse()) {
            ...
            const { minimumConfidence, minimumReleaseAge, releaseTimestamp, version: newVersion, updateType, } = releaseConfig;
            if (is_1.default.nonEmptyString(minimumReleaseAge) && releaseTimestamp) {
                if ((0, date_1.getElapsedMs)(releaseTimestamp) <
            ...
            if ((0, merge_confidence_1.isActiveConfidenceLevel)(minimumConfidence)) {
                const confidenceLevel = (await (0, merge_confidence_1.getMergeConfidenceLevel)(datasource, depName, currentVersion, newVersion, updateType)) ?? 'neutral';
                // TODO #22198
