...
function filterVersions(config, currentVersion, latestVersion, releases, versioning) {
    ...
    if (allowedVersions) {
        ...
        if (isAllowedPred) {
            ...
            filteredVersions = filteredVersions.filter((v) => semver_1.default.satisfies(semver_1.default.valid(v.version) ? v.version : semver_1.default.coerce(v.version), allowedVersions));
        }
    ...
    return filteredVersions.filter((v) => {
        ...
        if (versioning.getMajor(v.version) !== versioning.getMajor(currentVersion)) {
            return false;
        }
        ...
        return (versioning.getMinor(v.version) === versioning.getMinor(currentVersion) &&
