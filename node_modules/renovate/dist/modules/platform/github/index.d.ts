...
import type { AutodiscoverConfig, BranchStatusConfig, CreatePRConfig, EnsureCommentConfig, EnsureCommentRemovalConfig, EnsureIssueConfig, EnsureIssueResult, FindPRConfig, MergePRConfig, PlatformParams, PlatformResult, ReattemptPlatformAutomergeConfig, RepoParams, RepoResult, UpdatePrConfig } from '../types';
import { GithubIssue as Issue } from './issue';
import type { GhPr, GhRestRepo } from './types';
export declare const id = "github";
export declare const GitHubMaxPrBodyLen = 60000;
...
export declare function initRepo({ endpoint, repository, forkCreation, forkOrg, forkToken, renovateUsername, cloneSubmodules, ignorePrAuthor, }: RepoParams): Promise<RepoResult>;
...
export declare function createPr({ sourceBranch, targetBranch, prTitle: title, prBody: rawBody, labels, draftPR, platformOptions, milestone, }: CreatePRConfig): Promise<GhPr | null>;
...
export declare function reattemptPlatformAutomerge({ number, platformOptions, }: ReattemptPlatformAutomergeConfig): Promise<void>;
