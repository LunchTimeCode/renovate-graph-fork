...
async function createPr({ sourceBranch, targetBranch, prTitle: title, prBody: body, labels, draftPR = false, platformOptions, }) {
    ...
    if (platformOptions?.usePlatformAutomerge) {
        const mergeStrategy = platformOptions.automergeStrategy === 'auto'
            ? await getMergeStrategy(pr.targetRefName)
            : (0, util_2.mapMergeStrategy)(platformOptions.automergeStrategy);
    ...
    // TODO #22198
    pr.pullRequestId)));
    return (0, util_2.getRenovatePRFormat)(pr);
}
exports.createPr = createPr;
async function updatePr({ number: prNo, prTitle: title, prBody: body, state, platformOptions, targetBranch, }) {
