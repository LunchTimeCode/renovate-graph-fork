...
exports.getAllProjectTeams = exports.getMergeMethod = exports.getCommitDetails = exports.getFile = exports.getAzureBranchObj = exports.getRefs = void 0;
        ...
        try {
            ...
            if (result.success) {
                if (result.data.typeKey === 'GitItemNotFoundException') {
                    logger_1.logger.warn(`Unable to find file ${filePath}`);
                    return null;
                }
                if (result.data.typeKey === 'GitUnresolvableToCommitException') {
                    logger_1.logger.warn(`Unable to find branch ${branchName}`);
                    return null;
                }
            }
        }
