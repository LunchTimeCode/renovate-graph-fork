...
export declare function initRepo({ repository, cloneSubmodules, ignorePrAuthor, gitUrl, endpoint, includeMirrors, }: RepoParams): Promise<RepoResult>;
...
export declare function updatePr({ number: iid, prTitle, prBody: description, addLabels, removeLabels, state, platformOptions, targetBranch, }: UpdatePrConfig): Promise<void>;
export declare function reattemptPlatformAutomerge({ number: iid, platformOptions, }: ReattemptPlatformAutomergeConfig): Promise<void>;
