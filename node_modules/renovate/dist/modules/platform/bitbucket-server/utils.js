...
exports.getExtraCloneOpts = exports.getRepoGitUrl = exports.getInvalidReviewers = exports.isInvalidReviewersResponse = exports.accumulateValues = exports.prInfo = exports.BITBUCKET_INVALID_REVIEWERS_EXCEPTION = void 0;
const tslib_1 = require("tslib");
// SEE for the reference https://github.com/renovatebot/renovate/blob/c3e9e572b225085448d94aa121c7ec81c14d3955/lib/platform/bitbucket/utils.js
const node_url_1 = tslib_1.__importStar(require("node:url"));
...
function generateUrlFromEndpoint(defaultEndpoint, opts, repository) {
    ...
    const generatedUrl = git.getUrl({
        ...
        host: `${url.host}${url.pathname}${url.pathname.endsWith('/') ? '' : /* istanbul ignore next */ '/'}scm`,
        repository,
    });
