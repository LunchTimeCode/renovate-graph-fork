...
async function getCurrentUser(options) {
    ...
    const res = await exports.giteaHttp.getJson(url, options);
    return res.body;
}
...
async function searchRepos(params, options) {
    ...
    const res = await exports.giteaHttp.getJson(url, {
        ...options,
        paginate: true,
    });
    if (!res.body.ok) {
