...
exports.extractPackageFile = exports.dependencyPattern = exports.extrasPattern = exports.packagePattern = void 0;
...
exports.dependencyPattern = `(${exports.packagePattern})(${exports.extrasPattern})(${specifierPattern})`;
function extractPackageFile(content) {
    ...
    const res = (0, common_1.extractPackageFileFlags)(content);
    res.deps = deps;
    if (!res.deps.length &&
