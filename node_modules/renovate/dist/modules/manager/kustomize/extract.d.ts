...
export declare function extractImage(image: Image, aliases?: Record<string, string> | undefined): PackageDependency | null;
export declare function extractHelmChart(helmChart: HelmChart, aliases?: Record<string, string> | undefined): PackageDependency | null;
