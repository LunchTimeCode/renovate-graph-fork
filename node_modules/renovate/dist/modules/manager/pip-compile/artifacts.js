...
async function updateArtifacts({ packageFileName: inputFileName, newPackageFileContent: newInputContent, updatedDeps, config, }) {
    ...
    for (const outputFileName of config.lockFiles) {
        ...
        try {
            ...
            const pythonVersion = (0, common_2.extractPythonVersion)(existingOutput, outputFileName);
            ...
            const execOptions = await (0, common_2.getExecOptions)(config, cwd, (0, common_2.getRegistryCredVarsFromPackageFiles)(packageFiles), pythonVersion);
