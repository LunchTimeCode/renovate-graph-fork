...
exports.extractAllPackageFiles = exports.extractPackageFile = exports.extractProxyUrls = void 0;
        ...
        for (const dep of pkg.deps) {
            if (dep.datasource !== github_releases_1.GithubReleasesDatasource.id) {
                if (proxyUrls.length > 0) {
                    ...
                    dep.registryUrls.unshift(sbt_plugin_1.SBT_PLUGINS_REPO, SBT_MVN_REPO);
                }
                else {
