...
exports.upgradeableTooling = {
    ...
    java: {
        ...
        config: (version) => {
            ...
            const semeruJdkMatches = version.match(/^semeru-openj9-(?<version>\d\S+)_openj9-(?<openj9>\d\S+)/)?.groups;
            if (semeruJdkMatches) {
                return {
                    datasource: java_version_1.JavaVersionDatasource.id,
                    packageName: 'java-jdk',
            ...
            const semeruJreMatches = version.match(/^semeru-jre-openj9-(?<version>\d\S+)_openj9-\d\S+/)?.groups;
            if (semeruJreMatches) {
                return {
                    datasource: java_version_1.JavaVersionDatasource.id,
                    packageName: 'java-jre',
