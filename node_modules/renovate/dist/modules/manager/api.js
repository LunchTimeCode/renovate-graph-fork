...
const asdf = tslib_1.__importStar(require("./asdf"));
...
const bazelModule = tslib_1.__importStar(require("./bazel-module"));
const bazelisk = tslib_1.__importStar(require("./bazelisk"));
const bicep = tslib_1.__importStar(require("./bicep"));
...
const bun = tslib_1.__importStar(require("./bun"));
...
const cpanfile = tslib_1.__importStar(require("./cpanfile"));
const crossplane = tslib_1.__importStar(require("./crossplane"));
const depsEdn = tslib_1.__importStar(require("./deps-edn"));
const devContainer = tslib_1.__importStar(require("./devcontainer"));
...
const mavenWrapper = tslib_1.__importStar(require("./maven-wrapper"));
const meteor = tslib_1.__importStar(require("./meteor"));
const mint = tslib_1.__importStar(require("./mint"));
const mix = tslib_1.__importStar(require("./mix"));
const nix = tslib_1.__importStar(require("./nix"));
...
const ocb = tslib_1.__importStar(require("./ocb"));
const osgi = tslib_1.__importStar(require("./osgi"));
const pep621 = tslib_1.__importStar(require("./pep621"));
...
const scalafmt = tslib_1.__importStar(require("./scalafmt"));
const setupCfg = tslib_1.__importStar(require("./setup-cfg"));
const swift = tslib_1.__importStar(require("./swift"));
const tekton = tslib_1.__importStar(require("./tekton"));
...
const tflintPlugin = tslib_1.__importStar(require("./tflint-plugin"));
const travis = tslib_1.__importStar(require("./travis"));
const velaci = tslib_1.__importStar(require("./velaci"));
const vendir = tslib_1.__importStar(require("./vendir"));
const woodpecker = tslib_1.__importStar(require("./woodpecker"));
const api = new Map();
exports.default = api;
