...
exports.DartVersionDatasource = exports.stableVersionRegex = void 0;
    ...
    async getReleases({ registryUrl, }) {
        ...
        try {
            for (const channel of this.channels) {
                const resp = (await this.http.getJson(`${registryUrl}/storage/v1/b/dart-archive/o?delimiter=%2F&prefix=channels%2F${channel}%2Frelease%2F&alt=json`)).body;
