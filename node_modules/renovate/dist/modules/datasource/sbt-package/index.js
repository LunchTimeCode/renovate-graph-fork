...
class SbtPackageDatasource extends maven_1.MavenDatasource {
    ...
    async getReleases(config) {
        ...
        logger_1.logger.debug(`No versions discovered for ${packageName} listing organization root package folder, fallback to maven datasource for version discovery`);
