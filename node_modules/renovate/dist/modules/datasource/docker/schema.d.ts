...
export declare const OciImageManifest: z.ZodObject<z.objectUtil.extendShape<{
    ...
    config: z.ZodObject<z.objectUtil.extendShape<{
        ...
        mediaType: z.ZodEnum<["application/vnd.oci.image.config.v1+json", "application/vnd.cncf.helm.config.v1+json", "application/vnd.devcontainers"]>;
    }>, "strip", z.ZodTypeAny, {
        digest: string;
        mediaType: "application/vnd.oci.image.config.v1+json" | "application/vnd.cncf.helm.config.v1+json" | "application/vnd.devcontainers";
        size?: number | null | undefined;
    }, {
        digest: string;
        mediaType: "application/vnd.oci.image.config.v1+json" | "application/vnd.cncf.helm.config.v1+json" | "application/vnd.devcontainers";
