...
exports.getDependencyInfo = exports.createUrlForDependencyPom = exports.getDependencyParts = exports.downloadMavenXml = exports.getMavenUrl = exports.checkResource = exports.checkS3Resource = exports.downloadArtifactRegistryProtocol = exports.downloadS3Protocol = exports.downloadHttpProtocol = void 0;
...
async function downloadS3Protocol(pkgUrl) {
    ...
    try {
        ...
        const { Body: res } = await (0, s3_1.getS3Client)().send(new client_s3_1.GetObjectCommand(s3Url));
        if (res instanceof node_stream_1.Readable) {
            return (0, streams_1.streamToString)(res);
        }
        logger_1.logger.debug(`Expecting Readable response type got '${typeof res}' type instead`);
    }
    catch (err) {
        const failedUrl = pkgUrl.toString();
...
async function downloadMavenXml(http, pkgUrl) {
    ...
    switch (pkgUrl.protocol) {
        ...
        case 'artifactregistry:':
            ...
            break;
        default:
            logger_1.logger.debug(`Unsupported Maven protocol url:${pkgUrl.toString()}`);
            return {};
    }
    if (!rawContent) {
