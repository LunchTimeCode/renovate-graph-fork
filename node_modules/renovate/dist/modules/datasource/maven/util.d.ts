...
export declare function downloadHttpProtocol(http: Http, pkgUrl: URL | string, opts?: HttpOptions): Promise<Partial<HttpResponse>>;
export declare function downloadS3Protocol(pkgUrl: URL): Promise<string | null>;
export declare function downloadArtifactRegistryProtocol(http: Http, pkgUrl: URL): Promise<Partial<HttpResponse>>;
