...
class MavenDatasource extends datasource_1.Datasource {
        ...
        if (!workingReleaseMap) {
            ...
            try {
                ...
                for (const line of body.split(regex_1.newlineRegex)) {
                    ...
                    if (match) {
                        const { version, releaseTimestamp: timestamp } = match?.groups ?? /* istanbul ignore next: hard to test */ {};
    ...
    async addReleasesUsingHeadRequests(inputReleaseMap, dependency, repoUrl) {
        ...
        const cacheValid = await packageCache.get(cacheTimeoutNs, cacheKey);
        ...
        const freshVersions = (0, filter_map_1.filterMap)(Object.entries(releaseMap), ([version, release]) => {
