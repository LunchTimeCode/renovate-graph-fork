...
const logFactory = (_level) => {
    return (p1, p2) => {
        let level = _level;
        if (p2) {
            // meta and msg provided
            const msg = p2;
            const meta = { logContext, ...curMeta, ...p1 };
...
exports.logger = { once: { reset: once_1.reset } };
loggerLevels.forEach((loggerLevel) => {
    exports.logger[loggerLevel] = logFactory(loggerLevel);
    const logOnceFn = (p1, p2) => {
        (0, once_1.once)(() => {
            const logFn = exports.logger[loggerLevel];
            if (is_1.default.undefined(p2)) {
                logFn(p1);
            }
            else {
                logFn(p1, p2);
    ...
    exports.logger.once[loggerLevel] = logOnceFn;
});
